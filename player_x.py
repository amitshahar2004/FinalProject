        ...
        if my_turn == True:
            try:
                ...
                if data == 'Exit':
                    ...
                    my_socket.close()
                    wrote_winner(screen, "player o out of the game!")
                if data == 'It worked!' or data == 'Player x is the winner!' or data == 'There is no winner!':
                    draw_player_x(last_click_row, last_click_column, screen)
                    my_turn = False
                else:
            ...
            try:
                ...
                if data1 == 'Exit' and data == 'Exit':
                    ...
                    row_o = int(data1[0])
                    column_o = int(data1[1])
                    draw_player_o(row_o, column_o, screen)
                    my_turn = True
            except:
                sys.exit()
...
def from_click_to_cell_in_array(pos_x, pos_y, screen, my_socket):
    ...
    print('sending row x: ' + str(last_click_row) + ' column x: ' + str(last_click_column))
...
def wrote_winner(screen, data):
        ...
        if data == 'Player x is the winner!':
...
def main():
    ...
    screen.fill(WHITE)
    pygame.display.flip()
    pygame.display.set_caption("player X")
